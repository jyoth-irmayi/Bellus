...
urlpatterns = [
    ...
    # path('wishlist/add/<int:variant_id>/<int:variansize_id>/', views.add_to_wishlist, name='add_to_wishlist'),
    ...
    path('wishlist/add_to_cart/<int:variant_id>/<int:variansize_id>/', views.add_to_cart_from_wishlist, name='add_to_cart_from_wishlist'),
